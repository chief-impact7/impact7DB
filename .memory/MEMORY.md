...
- [진단평가 라벨·검색·필터 버그 3종](project_diagnostic_label_filter_fixes.md) — 지역명 풀네임 제거(약어학교 보호)·상담생 검색 사각지대(updated_at→first_registered 폴백)·temp_attendance "초6"(school 폴백). 진단평가 생성 updated_at 보강. shared v1.18.0 (2026-05-31)
