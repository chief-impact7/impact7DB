...
**작업 repo 경로:**
- impact7DB: `/Users/jongsooyi/projects/impact7DB` (현재 worktree에서 작업)
- impact7exam: `/Users/jongsooyi/projects/impact7exam`
- impact7newDSC: `/Users/jongsooyi/projects/impact7newDSC`
...
> repo 이동: `/Users/jongsooyi/projects/impact7exam`. 각 모듈은 `@google/genai` vertex 모드로 전환. retry/fallback 정책 유지. 모델명은 Phase 0 확정값 사용.
...
Run: `cd /Users/jongsooyi/projects/impact7exam && grep '"@google/genai"' package.json`
Expected: 이미 존재(generate.ts가 사용 중). 없으면 `npm install @google/genai`.

- [ ] **Step 3: Commit (impact7exam repo)**

```bash
cd /Users/jongsooyi/projects/impact7exam
...
Run: `cd /Users/jongsooyi/projects/impact7exam && npx tsc --noEmit`
...
Run: `cd /Users/jongsooyi/projects/impact7exam && npm test 2>&1 | tail -30`
...
> repo 이동: `/Users/jongsooyi/projects/impact7newDSC`. 클라 Vertex(`firebase/ai`)를 게이트웨이 Callable로 교체.
...
Run: `cd /Users/jongsooyi/projects/impact7newDSC && cat firebase-config.js`
...
Run:
```bash
cd /Users/jongsooyi/projects/impact7newDSC && grep -n "generateContent" -A3 gemini-queue.js parent-message.js
```
...
Run: `cd /Users/jongsooyi/projects/impact7newDSC && grep -rn "AppCheck\|app-check\|ReCaptcha" --include="*.js" . | grep -v node_modules`
...
Run: `cd /Users/jongsooyi/projects/impact7DB/.claude/worktrees/shared-backend-foundation && grep -n "match /" firestore.rules | head -40`
...
Run: `cd /Users/jongsooyi/projects/impact7DB/.claude/worktrees/shared-backend-foundation && firebase deploy --only firestore:rules --project impact7db --dry-run 2>&1 | tail -5`
...
Run:
```bash
cd /Users/jongsooyi/projects/impact7DB/.claude/worktrees/shared-backend-foundation
...
Run: `cd /Users/jongsooyi/projects/impact7newDSC && npx vite build && firebase deploy --only hosting --project impact7db`
Expected: 빌드·배포 성공.
...
**Files:**
- Modify: `/Users/jongsooyi/projects/impact7DB/.memory/project_shared_backend_foundation.md`
- Modify: `/Users/jongsooyi/projects/impact7DB/.memory/MEMORY.md` (필요 시)
